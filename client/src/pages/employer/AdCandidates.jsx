...
import { ArrowLeftIcon, UserIcon, StarIcon, EnvelopeIcon } from '@heroicons/react/24/outline'
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        {candidates.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No candidates allocated</h3>
            <p className="text-gray-600">
              Candidates will appear here once the Branch Admin allocates them to this job posting.
            </p>
          </div>
        )}
      </div>
