...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navigation = [
    { name: t('branchAdmin.sidebar.dashboard', 'Dashboard'), href: "/branch-admin/dashboard", icon: HomeIcon },
    { name: t('branchAdmin.sidebar.employers', 'Employers'), href: "/branch-admin/employers", icon: BuildingOfficeIcon },
    { name: t('branchAdmin.sidebar.adsApprovals', 'Ad Approvals'), href: "/branch-admin/ads-approvals", icon: DocumentCheckIcon },
    { name: t('branchAdmin.sidebar.screening', 'Candidate Screening'), href: "/branch-admin/screening", icon: UsersIcon },
    { name: t('branchAdmin.sidebar.mou', 'MOU Management'), href: "/branch-admin/mou", icon: DocumentTextIcon },
    { name: t('branchAdmin.sidebar.profile', 'Admin Profile'), href: "/branch-admin/profile", icon: UsersIcon },
    { name: t('branchAdmin.sidebar.reports', 'Reports'), href: "/branch-admin/reports", icon: ChartBarIcon },
    { name: t('branchAdmin.sidebar.logs', 'Activity Logs'), href: "/branch-admin/logs", icon: ClipboardDocumentListIcon },
  ];

  const developmentNav = [
    { name: t('branchAdmin.sidebar.testInterface', 'Test Interface'), href: "/branch-admin/test", icon: BeakerIcon },
  ];
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-center h-16 px-4 border-b border-neutral-200 bg-gradient-to-r from-blue-50 to-orange-50">
          <Link to="/branch-admin/dashboard" className="flex items-center hover:scale-105 transition-transform duration-200">
            <img 
              src={logoImage} 
              alt="LokalHunt" 
