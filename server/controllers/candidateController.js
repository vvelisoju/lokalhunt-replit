...
class CandidateController {
  ...
  async getProfile(req, res, next) {
    try {
      ...
      res.json(createResponse('Profile retrieved successfully', enhancedCandidate));
    } catch (error) {
      next(error);
    }
  }
  ...
  async updateProfile(req, res, next) {
    try {
      ...
      res.json(createResponse('Profile updated successfully', enhancedUpdatedCandidate));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getDashboard(req, res, next) {
    try {
      ...
      const applicationStats = {
        ...
        applied: candidate.allocations.filter(a => a.status === 'APPLIED').length,
        screened: candidate.allocations.filter(a => a.status === 'SCREENED').length,
        allocated: candidate.allocations.filter(a => a.status === 'ALLOCATED').length,
        shortlisted: candidate.allocations.filter(a => a.status === 'SHORTLISTED').length,
        hired: candidate.allocations.filter(a => a.status === 'HIRED').length,
        rejected: candidate.allocations.filter(a => a.status === 'REJECTED').length
      };
      ...
      res.json(createResponse('Dashboard data retrieved successfully', dashboardData));
    } catch (error) {
      next(error);
    }
  }
  ...
  async applyToJob(req, res, next) {
    try {
      ...
      res.status(201).json(createResponse('Application submitted successfully', application));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getApplications(req, res, next) {
    try {
      ...
      res.json(createResponse('Applications retrieved successfully', applicationsWithCount, pagination));
    } catch (error) {
      next(error);
    }
  }
  ...
  async toggleBookmark(req, res, next) {
    try {
      ...
      if (existingBookmark) {
        ...
        res.json(createResponse('Bookmark removed successfully', { bookmarked: false }));
      } else {
        // Add bookmark
        ...
        res.json(createResponse('Job bookmarked successfully', { bookmarked: true }));
      }
    } catch (error) {
      next(error);
    }
  ...
  async getBookmarks(req, res, next) {
    try {
      ...
      res.json(createResponse('Bookmarks retrieved successfully', bookmarksWithStatus, pagination));
    } catch (error) {
      next(error);
    }
  }
  ...
  async updateBasicInfo(req, res, next) {
    try {
      ...
      res.json(createResponse('Basic information updated successfully', { user: updatedUser, candidate: updatedCandidate }));
    } catch (error) {
      next(error);
    }
  }
  ...
  async updateExperience(req, res, next) {
    try {
      ...
      res.json(createResponse('Experience updated successfully', updatedCandidate));
    } catch (error) {
      next(error);
    }
  }
  ...
  async updateEducation(req, res, next) {
    try {
      ...
      res.json(createResponse('Education updated successfully', updatedCandidate));
    } catch (error) {
      next(error);
    }
  }
  ...
  async uploadProfilePhoto(req, res, next) {
    try {
      ...
      res.json(createResponse('Profile photo uploaded successfully', { profilePhoto: updatedCandidate.profilePhoto }));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getResume(req, res, next) {
    try {
      ...
      if (!candidate?.resumeUrl) {
        return res.status(404).json(createErrorResponse('No resume found', 404));
      }
  ...
  async updateOpenToWorkStatus(req, res, next) {
    try {
      ...
      res.json(createResponse('Open to Work status updated successfully', {
        openToWork,
  ...
  async getOpenToWorkStatus(req, res, next) {
    try {
      ...
      res.json(createResponse('Open to Work status retrieved successfully', {
        openToWork,
  ...
  async getProfileCompleteness(req, res, next) {
    try {
      ...
      if (!candidate.experience || candidate.experience.length === 0) recommendations.push('Add work experience');
      if (!candidate.education || candidate.education.length === 0) recommendations.push('Add education details');

      res.json(createResponse('Profile completeness retrieved successfully', {
        completeness,
        recommendations,
  ...
  async getActivityFeed(req, res, next) {
    try {
      ...
      res.json(createResponse('Activity feed retrieved successfully', activities.slice(skip, skip + parseInt(limit))));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getApplication(req, res, next) {
    try {
      ...
      res.json(createResponse('Application retrieved successfully', application));
    } catch (error) {
      next(error);
    }
  }
  ...
  async withdrawApplication(req, res, next) {
    try {
      ...
      if (!application) {
        return res.status(404).json(createErrorResponse('Application not found or cannot be withdrawn. You may have already been allocated or hired for this position.', 404));
      }
      ...
      res.json(createResponse('Application withdrawn successfully. You can now apply to this job again if you wish.'));
    } catch (error) {
      next(error);
    }
  }
  ...
  async updateApplicationNotes(req, res, next) {
    try {
      ...
      res.json(createResponse('Application notes updated successfully', updatedApplication));
    } catch (error) {
      next(error);
    }
  }
  ...
  async removeBookmark(req, res, next) {
    try {
      ...
      if (deleted.count === 0) {
        return res.status(404).json(createErrorResponse('Bookmark not found', 404));
      }
  ...
  async clearAllBookmarks(req, res, next) {
    try {
      ...
      res.json(createResponse(`${deleted.count} bookmarks cleared successfully`, { deletedCount: deleted.count }));
    } catch (error) {
      next(error);
    }
  }
    ...
    try {
      ...
      const jobs = await req.prisma.ad.findMany({
        where: {
          status: 'APPROVED',
          isActive: true,
          locationId: candidate.user.cityId,
      ...
      res.json(createResponse('Recommended jobs retrieved successfully', jobs, pagination));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getRecentlyViewedJobs(req, res, next) {
    try {
      ...
      // For now, return empty array as placeholder
      res.json(createResponse('Recently viewed jobs retrieved successfully', []));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getSkillRatingHistory(req, res, next) {
    try {
      ...
      res.json(createResponse('Skill rating history retrieved successfully', skillHistory));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getNotificationPreferences(req, res, next) {
    try {
      res.json(createResponse('Notification preferences retrieved successfully', {
  ...
  async updateAccountSettings(req, res, next) {
    try {
      ...
      res.json(createResponse('Account settings updated successfully', updatedUser));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getPrivacySettings(req, res, next) {
    try {
      res.json(createResponse('Privacy settings retrieved successfully', {
  ...
  async getApplicationStats(req, res, next) {
    try {
      ...
      res.json(createResponse('Application statistics retrieved successfully', formattedStats));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getProfileViews(req, res, next) {
    try {
      ...
      res.json(createResponse('Profile views retrieved successfully', {
        totalViews: 0,
        thisWeek: 0,
        thisMonth: 0
      }));
  ...
  async getMarketInsights(req, res, next) {
    try {
      ...
      res.json(createResponse('Market insights retrieved successfully', {
        demandForSkills: [],
        averageSalary: null,
        popularCompanies: [],
        growingIndustries: []
  ...
  async updateProfilePhoto(req, res, next) {
    try {
      ...
      res.json(createResponse('Profile photo updated successfully', updatedCandidate));
    } catch (error) {
      console.error('Update profile photo error:', error);
      res.status(500).json(
        createErrorResponse('Failed to update profile photo', 500)
      );
    }
  }
  ...
  async updateCoverPhoto(req, res, next) {
    try {
      ...
      res.json(createResponse('Cover photo updated successfully', updatedCandidate));
    } catch (error) {
      console.error('Update cover photo error:', error);
      res.status(500).json(
        createErrorResponse('Failed to update cover photo', 500)
      );
    }
  }
